...
const store_marketplace_1 = __importDefault(require("../ui/store-marketplace"));
const store_inventory_1 = __importDefault(require("../ui/store-inventory"));
const store_link_1 = __importDefault(require("../ui/store-link"));
const electron_1 = require("electron");
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('Store');
// Simple button option class
class StoreButton extends options_1.default {
    label;
    callback;
    buttonStyle;
    nameColor;
    ...
    generate() {
        ...
        if (this.nameColor) {
            ...
            if (nameElement) {
                nameElement.style.color = this.nameColor;
            }
        }
...
class StoreInfo extends options_1.default {
    content;
    constructor(module, opts) {
        super(module, opts);
...
class Store extends module_1.default {
    name = 'Water Store';
    id = 'store';
    marketplaceUI;
    inventoryUI;
    ...
    CODE_COOLDOWN = 10000; // 10 seconds
    isLinked = false;
    linkCheckInterval = null;
    lastLinkCheck = 0;
    isUnlinking = false;
    hasInitializedLinkStatus = false;
    constructor() {
        super();
        this.marketplaceUI = new store_marketplace_1.default(this);
        this.inventoryUI = new store_inventory_1.default(this);
        this.linkUI = new store_link_1.default(this);
    ...
    async pollLinkStatus() {
        ...
        if (!this.hasInitializedLinkStatus)
            return;
        ...
        try {
            ...
            if (!wasLinked && nowLinked) {
                ...
                // Focus the window
                try {
                    electron_1.ipcRenderer.send('focus-window');
                }
                catch (e) {
    ...
    showLinkSuccessNotification(discordUsername) {
