...
export default class Water extends Module {
    ...
    getUIToggles(): UIToggle[] {
        return [
            ...
            { id: 'removeCustomGames', name: 'Remove Custom Games', css: '#menuBtnCustomGames {display: none;} .serverHostOp { background-color: transparent !important; } .serverHostCommunity { font-size: 0; background-image: url(https://i.postimg.cc/25V0cbNg/Pink-Water.png) !important; background-position: center; background-size: cover; border: 6px solid #ff8abb; pointer-events: none !important; }', defaultOn: true },
